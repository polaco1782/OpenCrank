/*
 * OpenCrank C++11 - Built-in Tools Factory Functions (Legacy)
 * 
 * Free factory functions for creating individual agent tools.
 * These are retained for backward compatibility.
 * The preferred approach is to use BuiltinToolsProvider.
 */
